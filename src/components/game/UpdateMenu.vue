<template>
  <div>
    <ul class="menu menu-sm menu-horizontal bg-base-200 rounded-box w-full">
      <div class="flex flex-row w-full space-x-3.5">
        <li @click="$emit('open-update-modal', UpdateMode.Damage)" class="w-5">
        ...
        <li @click="$emit('open-update-modal', UpdateMode.Stats)" class="w-5">
        ...
        <li @click="$emit('open-update-modal', UpdateMode.Misc)" class="w-5">
        ...
        <li @click="$emit('open-update-modal', UpdateMode.Rival)" class="w-5">
          <a class="tooltip tooltip-bottom" data-tip="Rival">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
              <path
